...
<a href="index.jsp" class="nav-logo">
  ...
  <section id="hero"
    ...
    <div style="position:relative;z-index:2;max-width:680px;" class="anim-hero">
      ...
      <div style="display:flex;gap:1rem;flex-wrap:wrap;" class="anim-hero-delay">
        <a href="contact.jsp" class="btn-primary">Start Your Journey</a>
  ...
  <section class="alt">
    ...
    <p class="section-intro reveal">From your first dream to your first day on campus — we're with you through it all.
    </p>
    <div class="cards-grid reveal">
      <div class="card">
        <div class="card-icon">🎓</div>
        <h3>University Counselling</h3>
        <p>Personalised guidance to shortlist universities aligned with your academic profile, career goals, and budget.
        </p>
      </div>
      <div class="card">
        <div class="card-icon">📋</div>
      ...
      <div class="card">
        ...
        <p>Expert visa counselling and documentation support for student visas across the UK, USA, Australia, Canada &amp;
          more.</p>
      </div>
      <div class="card">
    ...
    <div style="margin-top:2.5rem;text-align:center;" class="reveal">
      <a href="services.jsp" class="btn-outline">View All Services →</a>
    </div>
  </section>
  ...
  <section>
    ...
    <div class="countries-grid reveal">
      <div class="country-pill"><span class="country-flag">🇦🇺</span>
    ...
    <div style="margin-top:2.5rem;text-align:center;" class="reveal">
      <a href="destination.jsp" class="btn-outline">Explore All Destinations →</a>
    </div>
  </section>
  ...
  <section class="dark">
    <div class="two-col">
      <div>
        ...
        <p class="section-intro reveal">Founded on a simple belief: every student deserves honest, expert guidance — not
          just a quick visa stamp.</p>
        <div class="why-list reveal">
          <div class="why-item">
            <div class="why-num">01</div>
            <div>
              <h4>Local Roots, Global Reach</h4>
              <p>Based in Pokhara with deep understanding of the Nepali student journey and worldwide university
                partnerships.</p>
            </div>
          </div>
          <div class="why-item">
        ...
        <div style="margin-top:2rem;" class="reveal">
          <a href="about.jsp" class="btn-outline">Learn More About Us →</a>
        </div>
      </div>
  ...
  <section class="alt">
    ...
    <div style="margin-top:2.5rem;text-align:center;" class="reveal">
      <a href="process.jsp" class="btn-outline">See Full Process →</a>
    </div>
  </section>
  ...
  <section
    ...
    <h2 class="reveal" style="max-width:600px;margin:0 auto 1.5rem;">Take the First Step<br><em>Towards Your Dream</em>
    </h2>
    <p style="color:var(--muted);font-size:1rem;max-width:480px;margin:0 auto 2.5rem;line-height:1.8;" class="reveal">
      Book a free consultation today and let our expert counsellors chart the best path for your education abroad.</p>
    <div class="reveal">
