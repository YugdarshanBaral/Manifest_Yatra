...
<body>
  ...
  <div class="nav-drawer" id="navDrawer">
    ...
    <div class="drawer-dropdown">
      ...
      <div class="drawer-sub">
        <a href="registration.html">✏️ &nbsp;Sign Up</a>
        <a href="login.html">🔑 &nbsp;Login</a>
        <a href="admin.html">🛡️ &nbsp;Login as Administrator</a>
      </div>
    </div>
    <a href="contact.html" class="drawer-cta">Free Consultation →</a>
  </div>
  ...
  <div class="auth-page">
    <div style="width:100%;max-width:480px;">
      ...
      <div class="auth-card">
        ...
        <p style="font-size:0.82rem;color:var(--muted-light);margin-bottom:1.8rem;line-height:1.6;">Join hundreds of
          students on their study abroad journey.</p>

        <!-- Role selection -->
        <div style="margin-bottom:1.2rem;">
          <label
            style="font-size:0.68rem;letter-spacing:0.12em;text-transform:uppercase;color:var(--muted-light);display:block;margin-bottom:0.6rem;font-weight:500;">I
            am a</label>
        ...
        <div class="auth-form">
          <div class="form-row">
            <div class="form-group">
              ...
              <input type="text" placeholder="First name" id="reg-fname" required />
            </div>
            <div class="form-group">
              <label>Last Name *</label>
              <input type="text" placeholder="Last name" id="reg-lname" required />
            </div>
          </div>
          <div class="form-group">
            <label>Email Address *</label>
            <input type="email" placeholder="your@email.com" id="reg-email" required />
          </div>
          <div class="form-group">
            <label>Phone Number</label>
            <input type="tel" placeholder="+977 98XXXXXXXX" id="reg-phone" />
          </div>
          <div class="form-group">
            <label>Password *</label>
            <input type="password" placeholder="Min. 8 characters" id="reg-pass" oninput="checkStrength(this.value)"
              required />
          ...
          <div class="form-group">
            ...
            <input type="password" placeholder="Re-enter password" id="reg-pass2" required />
          </div>
          ...
          <div style="display:flex;align-items:flex-start;gap:0.7rem;margin-top:0.3rem;">
            ...
            <label for="terms" style="font-size:0.78rem;color:var(--muted-light);line-height:1.55;cursor:pointer;">
              I agree to the <a href="#" style="color:var(--sky);">Terms of Service</a> and <a href="#"
                style="color:var(--sky);">Privacy Policy</a>
            </label>
          </div>

          <button class="btn-primary" style="width:100%;margin-top:0.6rem;font-size:0.85rem;padding:1rem;"
  ...
  <script>
    ...
    function checkStrength(val) {
      ...
      const colors = ['#e74c3c', '#e07c3a', '#d4a843', '#4a9edd', '#2ecc71'];
    ...
    function handleRegister(e) {
      ...
      alert('Account created! Our team will contact you shortly to proceed with your consultation.');
    }
  </script>
</body>
